...
import { PropiedadComponent } from 'app/entities/propiedad/propiedad.component';
...
describe('Component Tests', () => {
  describe('Propiedad Management Component', () => {
    let comp: PropiedadComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PropiedadComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.propiedads[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
